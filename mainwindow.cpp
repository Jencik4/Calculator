    ...
    QMainWindow(parent)
{
    ...
    line_2 -> setStyleSheet("QLineEdit {background-color: rgb(168, 168, 168); border: 1px solid rgb(168, 168, 168)}");
    ...
    clear->setStyleSheet("QPushButton {background-color: rgb(20,180,40); border: 1px solid rgb(20,180,40)} QPushButton:hover {background-color: rgb(20,200,40); border: 1px solid rgb(20,180,40)} QPushButton:pressed {background-color: rgb(20,220,40); border: 1px solid rgb(20,220,40)}");
    clear->setFont(QFont("consolas", 9));
    del->setMinimumSize(84, 40);
    del->setStyleSheet("QPushButton {background-color: rgb(20,180,40); border: 1px solid rgb(20,180,40)} QPushButton:hover {background-color: rgb(20,200,40); border: 1px solid rgb(20,180,40)} QPushButton:pressed {background-color: rgb(20,220,40); border: 1px solid rgb(20,220,40)}");
    ...
    QPushButton *digitButtons[24];
      ...
      for (int i=0; i<values.length(); i++){
          ...
          if (i<15)   digitButtons[i]->setStyleSheet("QPushButton {background-color: rgb(0, 240, 70); border: 1px solid rgb(0, 240, 70)} QPushButton:hover {background-color: rgb(0, 255, 70); border: 1px solid rgb(0, 255, 70)} QPushButton:pressed {background-color: rgb(20, 255, 90); border: 1px solid rgb(20, 255, 90)}");
          else if (i>15)    digitButtons[i]->setStyleSheet("QPushButton {background-color: rgb(40, 190, 100); border: 1px solid rgb(40, 190, 100)} QPushButton:hover {background-color: rgb(40, 210, 100); border: 1px solid rgb(40, 210, 100)} QPushButton:pressed {background-color: rgb(40, 230, 100); border: 1px solid rgb(40, 230, 100)}");
          else if (i==15)   digitButtons[i]->setStyleSheet("QPushButton {background-color: rgb(20,180,40); border: 1px solid rgb(20,180,40)} QPushButton:hover {background-color: rgb(100, 250, 130); border: 1px solid rgb(100, 255, 130)} QPushButton:pressed {background-color: rgb(120, 255, 150); border: 1px solid rgb(120, 255, 150)}");
    ...
    central ->setStyleSheet("background-color: rgb(20,100,40)");
